...
if (formElement) {
  ...
  const productRating = parseFloat(document.getElementById("rating").value);
  const productRatingCount = parseInt(document.getElementById("ratingCount").value);
  const productKeywords = document.getElementById("keywords").value.split(',').map(keyword => keyword.trim());
  
  // Push new product to the array
  products.push({
    id: productId,
    image: productImage,
    name: productName,
